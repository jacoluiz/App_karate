...
fun TelaListaArmamento(
    ...
    onCardClick: (armamento: Armamento) -> Unit // Callback para navegação ou troca de tela
) {
    ...
    LazyColumn(
        ...
        items(uiState.armamento) { armamento ->
            Card(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                onClick = { onCardClick(armamento) } // Ao clicar no Card
            ) {
                Column(
