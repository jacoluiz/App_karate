package br.com.shubudo.ui.view.recursos.programacao.detalheMovimento.SequenciaExtraBanner
    ...
    LazyColumn(
        ...
        items(uiState.sequenciaExtraBanner.sortedBy { it.numeroOrdem }) { extraBanner ->
            Card(
                ...
                onClick = { onCardClick(extraBanner) }
            ) {
                Column(
                    ...
                    Row(
                        ...
                        Row(
                            ...
                            Icon(
                                imageVector = ImageVector.vectorResource(id = R.drawable.ic_defesa_pessoal),
                                contentDescription = "Defesa Extra Banner",
                    ...
                    Column(
                        ...
                        extraBanner.movimentos.take(3).forEach { movimento ->
                            Text(
                                text = "• ${movimento.nome}",
